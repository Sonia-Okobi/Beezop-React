    ...
    <div className="signup-page signin-page">
      <div className="illustration">
        <div className="illustration__heading">
          ...
          <p>
            Beezop helps you to document your business processes and share with
            your team, so you never have to repeat yourself again.
          </p>
        </div>
        <img
          src={illustration}
      ...
      <div className="auth">
        <div className="auth__form">
          <div className="auth__form__heading">
            <h3 className="auth__form__heading__title">
              Start using Beezop for FREE
            </h3>
            <p className="auth__form__heading__description">
              Sign up now to get 45+ ready-made processes to help you get
              started.
            </p>
          </div>
          <form>
            ...
            <p className="signup-page__text">
              ...
              <a href="/termspage">Terms of Use</a> and{' '}
              <a href="/privacypage">Privacy Policy</a>
            </p>
            <BaseButton className="signin-button">CREATE MY ACCOUNT</BaseButton>
            <p className="base-text">
              Already have an account?{' '}
              <a className="underline" href="/signinpage">
                Sign in Now
              </a>
            </p>
          </form>
