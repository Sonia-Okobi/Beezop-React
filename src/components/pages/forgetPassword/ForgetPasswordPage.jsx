...
import illustration from '../../../assets/images/auth-page.png';
    ...
    <div className="signin-page">
      <div className="illustration">
        <div className="illustration__heading">
          ...
          <p>
            Documenting your processes makes life easier for you and your
            employees.
          </p>
        </div>
        <img
      ...
      <div className="auth">
        <div className="auth__form">
          <div className="auth__form__heading">
            <h3 className="auth__form__heading__title">Forgot Password</h3>
